...
# TODO: Fix test cases
# def test_max_cancel_rate(strat_manager_service_web_client, pair_strat_, expected_start_status_,
#                          expected_strat_limits_, top_of_book_list_, buy_order_, sell_order_,
#                          symbol_overview_obj_list, last_trade_fixture_list, market_depth_basemodel_list):
...
#     override_order_limits(strat_manager_service_web_client)
#
...
#
#         pair_strat = strat_manager_service_web_client.get_pair_strat_client(active_pair_strat.id)
...
#
#
# def test_max_open_orders_per_side(pair_strat_, expected_start_status_,
#                                   expected_strat_limits_, top_of_book_list_, buy_order_, sell_order_,
#                                   symbol_overview_obj_list, last_trade_fixture_list, market_depth_basemodel_list):
#
#
...
#
#
# def test_consumable_cxl_qty(strat_manager_service_web_client, pair_strat_, expected_start_status_,
