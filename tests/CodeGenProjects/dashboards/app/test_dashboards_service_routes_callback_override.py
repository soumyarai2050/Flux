...
from Flux.CodeGenProjects.dashboards.generated.FastApi.dashboards_service_http_client import \
    DashboardsServiceHttpClient

dashboards_service_web_client: DashboardsServiceHttpClient = \
    DashboardsServiceHttpClient.set_or_get_if_instance_exists("127.0.0.1", 8010)
...
def test_sanity_underlying_time_series(dash_, dash_filter_, bar_data_):
    ...
    for index in range(1000):
        ...
        stored_dash_obj: DashBaseModel = dashboards_service_web_client.create_dash_client(dash_obj)
    ...
    for index in range(10):
        ...
        stored_dash_filters_obj = dashboards_service_web_client.create_dash_filters_client(dash_filters_obj)
        ...
        dash_collection_obj = DashCollectionBaseModel(id=stored_dash_filters_obj.id,
                                                      ...
                                                      buffered_dashes=[])
        dashboards_service_web_client.create_dash_collection_client(dash_collection_obj)
    dash_filters_collection_obj = DashFiltersCollectionBaseModel(loaded_dash_filters=dash_filters_ids,
                                                                 buffered_dash_filters=[])
    dashboards_service_web_client.create_dash_filters_collection_client(dash_filters_collection_obj)
    ...
    for _ in range(total_loops):
        ...
        dashboards_service_web_client.create_all_bar_data_client(pending_bars)
        dashboards_service_web_client.patch_all_dash_client(pending_dashes)
