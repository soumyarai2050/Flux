...
class PluginExecuteScript:
    ...
    def __init__(self, base_dir_path: str):
        ...
        self.plugin_path = \
            os.path.abspath(os.path.join(os.getenv("PLUGIN_DIR"), os.getenv("PLUGIN_FILE_NAME")))
    ...
    def import_pb2_scripts(self, proto_file_path_list: List[str], proto_files_dir_paths_list: List[str], out_dir: str):
        pb2_import_generator_path = os.path.join(os.getenv("PLUGIN_DIR"), os.getenv("PB2_IMPORT_GENERATOR_PATH"))
    ...
    def clear_used_imports_from_file(self):
        ...
        insertion_import_file_name = os.getenv("INSERTION_IMPORT_FILE_NAME")
