...
class ViteConfigGenPlugin(BaseJSLayoutPlugin):
    """
    Plugin script to generate vite.config.js with dynamic port configuration
    """

    def __init__(self, base_dir_path: str):
        super().__init__(base_dir_path)

    def handle_port_config(self, file: protogen.File) -> str:
        ...
        output_str = f'port: {ui_port},'
        return output_str

    def output_file_generate_handler(self, file: protogen.File):
        output_file_name = "vite.config.js"
        ...
        return {
            output_file_name: {
                "port_config": self.handle_port_config(file)
            }
        }


if __name__ == "__main__":
    main(ViteConfigGenPlugin)
