...
class JsonSchemaConvertPlugin(BaseProtoPlugin):
    ...
    flx_fld_simple_non_repeated_attribute_options: List[str] = [
        ...
        BaseProtoPlugin.flux_fld_background_color,
        BaseProtoPlugin.flux_fld_color_src,
        BaseProtoPlugin.flux_fld_background_color_src,
        BaseProtoPlugin.flux_fld_color_percentage,
        BaseProtoPlugin.flux_fld_background_color_percentage,
