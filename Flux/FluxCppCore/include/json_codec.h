        ...
        static inline void modify_json(std::string &r_json_str) {
            try {
                ...
                if (obj["side"].is_string()) {
                    ...
                    LOG_ERROR_IMPL(GetCppAppLogger(), "Error: 'side' field is not a string in JSON. JSON: {}", r_json_str);
                }
                r_json_str = boost::json::serialize(jv);
            } catch (const std::invalid_argument& e) {
                LOG_ERROR_IMPL(GetCppAppLogger(), "Invalid argument encountered: {}, JSON: {}", e.what(), r_json_str);
            } catch (const boost::json::system_error& e) {
                LOG_ERROR_IMPL(GetCppAppLogger(), "Parse error encountered: {}, JSON: {}", e.what(), r_json_str);
            }
        }
    ...
    public:
        ...
        encode_model(const RootModelType &kr_model_obj, std::string &r_json_out, const bool whitespace = false) {
            ...
            if (status.code() == absl::StatusCode::kOk)
                ...
                LOG_ERROR_IMPL(GetCppAppLogger(), "Failed Encoding {};;; error: {};;; {}: {}",
    ...
    public:
        ...
        decode_model_list(RootModelListType &r_model_list_obj_out, std::string &r_list_json) {
            ...
            if (status.code() == absl::StatusCode::kOk) {
                ...
                LOG_ERROR_IMPL(GetCppAppLogger(), "Failed Decoding {};;; error: {};;; list_json: {}",
