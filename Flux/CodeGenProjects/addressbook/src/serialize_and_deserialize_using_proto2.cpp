...
std::string SerializeAndDeserializeProto2::serialize_order_journal(const addressbook::OrderJournal& order_journal) {
...
addressbook::OrderJournal SerializeAndDeserializeProto2::deserialize_order_journal(const std::string& json_string) {
...
addressbook::OrderJournal SerializeAndDeserializeProto2::create_order_journal() {
