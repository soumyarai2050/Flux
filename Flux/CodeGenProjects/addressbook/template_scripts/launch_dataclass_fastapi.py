...
if __name__ == "__main__":
    ...
    from Flux.CodeGenProjects.AddressBook.ProjectGroup.template_project_name.generated.FastApi.template_model_service_launch_dataclass_server import \
        template_model_service_launch_dataclass_server
