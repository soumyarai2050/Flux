...
from FluxPythonUtils.contact_log_book.tail_executor import LogDetail
...
from Flux.PyCodeGenEngine.FluxCodeGenCore.app_contact_log_book import AppTailExecutor
...
from Flux.CodeGenProjects.AddressBook.ProjectGroup.contact_log_book.app.aggregate import *
...
class PhoneBookBaseTailExecutor(AppTailExecutor):
    ...
    def initialize_underlying_http_callables(cls):
        from Flux.CodeGenProjects.AddressBook.ProjectGroup.contact_log_book.generated.FastApi.contact_log_book_service_http_msgspec_routes import (
    ...
    def _handle_contact_alert_query_call_from_alert_queue_handler(
        ...
        contact_log_book_service_http_client.handle_contact_alerts_from_tail_executor_query_client(
    ...
    def handle_tail_restart(self, log_detail: LogDetail):
        ...
        contact_log_book_service_http_client.contact_log_book_restart_tail_query_client(log_detail.log_file_path,
                                                                                restart_datetime)
