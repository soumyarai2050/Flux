...
def get_dict_list_for_bar_meta_data_match(symbol: str, exch_id: str, bar_type: str | None = None) -> List[Dict[str, Any]]:
    agg_list = [
            {
...
def get_vwap_n_vwap_change_projection_from_bar_data_agg_pipeline(
        symbol: str, exch_id: str, bar_type: str, start_date_time: int | None = None,
