...
contact_fail_log_path = PurePath(__file__).parent.parent / "log" / contact_alert_fail_log
simulator_contact_fail_log_path = PurePath(__file__).parent.parent / "log" / simulator_contact_alert_fail_log
    ...
    while 1:
        if not os.path.exists(log_file_path):
            ...
            if os.path.getsize(log_file_path) > 0:
                ...
                mail_subject = "Contact Alert handling in log analyzer failed!"
...
if __name__ == "__main__":
    thread_list = []
    for log_file in [contact_fail_log_path, simulator_contact_fail_log_path]:
