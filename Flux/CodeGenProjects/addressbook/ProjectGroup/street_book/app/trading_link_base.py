...
class TradingLinkBase(ABC):
    ...
    simulate_config_yaml_path: str | None = None    # must be set before StreetBook is provided to TradingDataManager
    simulate_config_dict: Dict | None = None    # must be set before StreetBook is provided to TradingDataManager
