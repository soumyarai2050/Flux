...
class BaseBarteringDataManager:
    ...
    def __init__(self):
        ...
        self.plan_cache: BasePlanCache | None = None  # must be set by derived impl
    ...
    def underlying_handle_chore_snapshot_ws_(self, **kwargs):
        ...
        with self.plan_cache.re_ent_lock:
            ...
            if chore_snapshot_.chore_status == ChoreStatusType.OE_UNACK:
                is_unack = True
                BasePlanCache.chore_id_to_symbol_side_tuple_dict[chore_snapshot_.chore_brief.chore_id] = \
