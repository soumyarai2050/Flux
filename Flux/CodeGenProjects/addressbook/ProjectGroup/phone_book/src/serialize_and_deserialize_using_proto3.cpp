...
std::string SerializeAndDeserializeProto3::serialize_chore_journal(const phone_book::ChoreJournal& chore_journal) {
...
phone_book::ChoreJournal SerializeAndDeserializeProto3::deserialize_chore_journal(const std::string& json_string) {
...
phone_book::ChoreJournal SerializeAndDeserializeProto3::create_chore_journal() {
    ...
    choreJournal.mutable_chore()->mutable_security()->set_sec_type(phone_book::SecurityType::SEC_TYPE_UNSPECIFIED);
    choreJournal.mutable_chore()->set_side(phone_book::Side::BUY);
