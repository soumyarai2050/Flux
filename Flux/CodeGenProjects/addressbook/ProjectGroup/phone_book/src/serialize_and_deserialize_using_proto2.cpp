...
std::string SerializeAndDeserializeProto2::serialize_chore_ledger(const phone_book::ChoreLedger& chore_ledger) {
...
phone_book::ChoreLedger SerializeAndDeserializeProto2::deserialize_chore_ledger(const std::string& json_string) {
...
phone_book::ChoreLedger SerializeAndDeserializeProto2::create_chore_ledger() {
    ...
    choreLedger.mutable_chore()->mutable_security()->set_sec_type(SecurityType::SEC_TYPE_UNSPECIFIED);
    choreLedger.mutable_chore()->set_side(Side::BUY);
