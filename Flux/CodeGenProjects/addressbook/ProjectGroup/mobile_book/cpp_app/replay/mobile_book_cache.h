...
namespace mobile_book_cache {
            ...
            Py_Initialize();
	        {
                ...
                if (!p_mobile_book_container_instance) {
                    ...
                    if (kr_market_depth_obj.side() == mobile_book::TickType::BID) {
                            PyObject* p_get_bid_market_depth_from_depth = PyObject_GetAttrString(
                                p_mobile_book_container_instance, get_bid_market_depth_from_depth_key.c_str());
                            assert(p_get_bid_market_depth_from_depth != nullptr);

                            p_args = PyTuple_Pack(1, PyLong_FromLong(kr_market_depth_obj.position()));
                            p_market_depth_instance = PyObject_CallObject(
                                p_get_bid_market_depth_from_depth, p_args);
                            ...
                            PyObject* p_get_ask_market_depth_from_depth = PyObject_GetAttrString(
                                p_mobile_book_container_instance, get_ask_market_depth_from_depth_key.c_str());
                            assert(p_get_ask_market_depth_from_depth != nullptr);

                            p_args = PyTuple_Pack(1, PyLong_FromLong(kr_market_depth_obj.position()));
                            p_market_depth_instance = PyObject_CallObject(
                                p_get_ask_market_depth_from_depth, p_args);
                            if (p_market_depth_instance == Py_None) {
                                create_market_depth_cache(kr_market_depth_obj, p_mobile_book_container_instance);
                            } else {
    ...
    protected:
        ...
        void create_market_depth_cache(const mobile_book::MarketDepth &kr_market_depth_obj,
            PyObject* p_mobile_book_container_instance) {
        ...
        void update_bid_market_depth_cache(const mobile_book::MarketDepth &kr_market_depth_obj,
            PyObject* p_mobile_book_container_instance, PyObject* p_mutex) {
        ...
        void update_ask_market_depth_cache(const mobile_book::MarketDepth &kr_market_depth_obj,
            PyObject* p_mobile_book_container_instance, PyObject* p_mutex) {
    ...
    public:
        ...
        void update_or_create_last_barter_cache(const mobile_book::LastBarter &kr_last_barter_obj) {
...

		    {
                ...
                mp_market_barter_vol_class_ = PyObject_GetAttrString(p_module,
                    mobile_book_handler::market_barter_volume_msg_name.c_str());
                ...
                if (!p_mobile_book_container_instance) {
                    FluxCppCore::AddOrGetContainerObj::add_container_obj_for_symbol(
                        kr_last_barter_obj.symbol_n_exch_id().symbol());
                    ...
                    create_last_barter_cache(kr_last_barter_obj, p_mobile_book_container_instance,
                        mp_market_barter_vol_class_);
                    ...
                    if (p_last_barter_instance == Py_None) {
                        create_last_barter_cache(kr_last_barter_obj,
                            p_mobile_book_container_instance, mp_market_barter_vol_class_);
                    } else {
    ...
    protected:
        ...
        void create_last_barter_cache(const mobile_book::LastBarter &kr_last_barter_obj,
            PyObject* p_mobile_book_container_instance, PyObject* mp_market_barter_vol_class_) {
            ...
            p_market_barter_volume_args = PyTuple_Pack(3, PyUnicode_DecodeUTF8(
                kr_last_barter_obj.market_barter_volume().id().c_str(),
                    static_cast<Py_ssize_t>(kr_last_barter_obj.market_barter_volume().id().size()), nullptr),
            ...
            p_market_barter_volume_instance = PyObject_CallObject(
            mp_market_barter_vol_class_, p_market_barter_volume_args);

            p_args =
                FluxCppCore::MessageTypeToPythonArgs::message_type_to_python_args(
                    kr_last_barter_obj, p_market_barter_volume_instance);

            assert(Py_IsTrue(PyObject_CallObject(p_set_func, p_args)));
        }

        void update_last_barter_cache(const mobile_book::LastBarter &kr_last_barter_obj,
            PyObject* p_mobile_book_container_instance, PyObject* p_mutex) {
    ...
    public:
        void update_or_create_top_of_book_cache(const mobile_book::TopOfBook &kr_top_of_book) {
		    Py_Initialize();
		    {
                FluxCppCore::PythonGIL gil;
                ...
                p_mobile_book_container_instance =
                    FluxCppCore::AddOrGetContainerObj::get_mobile_book_container_instance(kr_top_of_book.symbol());
                ...
                if (!p_mobile_book_container_instance) {
                    ...
                    create_top_of_book_cache(kr_top_of_book,
                        p_mobile_book_container_instance, p_market_barter_volume_class);
                } else {
                    ...
                    if (p_top_of_book_instance == Py_None) {
                        create_top_of_book_cache(kr_top_of_book, p_mobile_book_container_instance,
                            p_market_barter_volume_class);
                    } else {
                        ...
                        if (kr_top_of_book.has_bid_quote()) {
                            ...
                            PyObject* p_get_top_of_book_bid_quote = PyObject_GetAttrString(
                                p_mobile_book_container_instance, get_top_of_book_bid_quote_key.c_str());
                        ...
                        if (kr_top_of_book.has_ask_quote()) {

                            PyObject* p_get_top_of_book_ask_quote = PyObject_GetAttrString(
                                p_mobile_book_container_instance, get_top_of_book_ask_quote_key.c_str());
                        ...
                        if (kr_top_of_book.has_last_barter()){

                            PyObject* p_get_top_of_book_last_barter = PyObject_GetAttrString(
                                p_mobile_book_container_instance, get_top_of_book_last_barter_key.c_str());
    ...
    protected:
        ...
        void create_top_of_book_cache(const mobile_book::TopOfBook &kr_top_of_book,
            PyObject* p_mobile_book_container_instance, PyObject* mp_market_barter_vol_class_) {
            ...
            for (int i = 0; i < kr_top_of_book.market_barter_volume_size(); ++i) {
                p_args = FluxCppCore::MessageTypeToPythonArgs::message_type_to_python_args(
                    kr_top_of_book.market_barter_volume(i));
            ...
            p_args = FluxCppCore::MessageTypeToPythonArgs::message_type_to_python_args(
                kr_top_of_book, p_market_barter_volume_list);

            assert(PyObject_IsTrue(PyObject_CallObject(p_set_func, p_args)));
        }

        void create_top_of_book_bid_quote(const mobile_book::TopOfBook &kr_top_of_book_obj,
            PyObject* p_mobile_book_container_instance) {

            PyObject* p_args = nullptr;

            PyObject* p_set_top_of_book_bid_quote = PyObject_GetAttrString(p_mobile_book_container_instance,
                set_top_of_book_bid_quote_key.c_str());
        ...
        void update_top_of_book_bid_quote(const mobile_book::TopOfBook &kr_top_book_obj,
            PyObject* p_mobile_book_container_instance, PyObject* p_mutex) {
        ...
        void create_top_of_book_ask_quote(const mobile_book::TopOfBook &kr_top_of_book_obj,
            PyObject* p_mobile_book_container_instance) {

            PyObject* p_args = nullptr;

            PyObject* p_set_top_of_book_ask_quote = PyObject_GetAttrString(p_mobile_book_container_instance,
                set_top_of_book_ask_quote_key.c_str());
        ...
        void update_top_of_book_ask_quote(const mobile_book::TopOfBook &kr_top_of_book_obj,
            PyObject* p_mobile_book_container_instance, PyObject* p_mutex) {
        ...
        void create_top_of_book_last_barter(const mobile_book::TopOfBook &kr_top_of_book_obj,
            PyObject* p_mobile_book_container_instance) {

            PyObject* p_args = nullptr;
            PyObject* p_set_top_of_book_last_barter = PyObject_GetAttrString(
        ...
        void update_top_of_book_last_barter(const mobile_book::TopOfBook &kr_top_of_book_obj,
            PyObject* p_mobile_book_container_instance, PyObject* p_mutex) {
        ...
        void update_top_of_book_top_lev_fld(const mobile_book::TopOfBook &kr_top_of_book_obj,
            PyObject* p_mobile_book_container_instance, [[maybe_unused]] PyObject* p_mutex) {
        ...
        PyObject* set_market_barter_volume(PyObject* p_mobile_book_container_instance,
