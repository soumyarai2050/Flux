...
class MobileBookServiceRoutesCallbackBeanieNativeOverride(MobileBookServiceRoutesCallbackBaseNativeOverride):
    ...
    async def get_bar_data_all_symbols_n_last_update_time_query_pre(self, bar_data_n_latest_update_date_time_class_type: Type[BarDataNLatestUpdateDateTime]):
        from Flux.CodeGenProjects.AddressBook.ProjectGroup.mobile_book.generated.FastApi.mobile_book_service_http_routes import \
            underlying_read_bar_data_http
        from Flux.CodeGenProjects.AddressBook.ProjectGroup.mobile_book.app.aggregate import get_latest_bar_data_for_each_symbol
    ...
    async def get_vwap_projection_from_bar_data_query_pre(self, bar_data_class_type: Type[BarData], symbol: str,
        ...
        from Flux.CodeGenProjects.AddressBook.ProjectGroup.mobile_book.generated.FastApi.mobile_book_service_http_routes import \
            underlying_read_bar_data_http
        from Flux.CodeGenProjects.AddressBook.ProjectGroup.mobile_book.app.aggregate import get_vwap_projection_from_bar_data_agg_pipeline
    ...
    async def get_vwap_change_projection_from_bar_data_query_pre(self, bar_data_class_type: Type[BarData], symbol: str,
        ...
        from Flux.CodeGenProjects.AddressBook.ProjectGroup.mobile_book.generated.FastApi.mobile_book_service_http_routes import \
            underlying_read_bar_data_http
        from Flux.CodeGenProjects.AddressBook.ProjectGroup.mobile_book.app.aggregate import get_vwap_change_projection_from_bar_data_agg_pipeline
        bar_data_projection_list = await underlying_read_bar_data_http(
    ...
    async def get_premium_projection_from_bar_data_query_pre(self, bar_data_class_type: Type[BarData], symbol: str,
        ...
        from Flux.CodeGenProjects.AddressBook.ProjectGroup.mobile_book.generated.FastApi.mobile_book_service_http_routes import \
            underlying_read_bar_data_http
        from Flux.CodeGenProjects.AddressBook.ProjectGroup.mobile_book.app.aggregate import get_premium_projection_from_bar_data_agg_pipeline
        bar_data_projection_list = await underlying_read_bar_data_http(
