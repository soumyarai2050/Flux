...
# 2. search replace template_project_name with project_name inferring project name from project directory name
# 3. search and replace template_model_service with inferring actual model service name form model
cd ..
