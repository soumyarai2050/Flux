...
env_var_dict["OUTPUT_FILE_NAME_SUFFIX"] = "json_sample.json"
env_var_dict["PLUGIN_FILE_NAME"] = "json_sample_gen_plugin.py"
env_var_dict["PB2_IMPORT_GENERATOR_PATH"] = "json_sample_pb2_import_gen.py"
env_var_dict["AUTOCOMPLETE_FILE_PATH"] = str(PurePath(__file__).parent.parent / "misc" / "autocomplete.json")
code_gen_engine_env_manager.init_env_and_update_sys_path("addressbook", "_", "PluginJSONSample", env_var_dict)
