...
class DashboardsServiceRoutesCallbackBaseNativeOverride(DashboardsServiceRoutesCallback):
    ...
    async def get_vwap_projection_from_bar_data_query_pre(self, bar_data_class_type: Type[BarData], symbol: str,
        ...
        from Flux.CodeGenProjects.dashboards.generated.FastApi.dashboards_service_http_routes import \
            underlying_read_bar_data_http
        from Flux.CodeGenProjects.dashboards.app.aggregate import get_vwap_projection_from_bar_data_agg_pipeline
    ...
    async def get_vwap_n_vwap_change_projection_from_bar_data_query_pre(self, bar_data_class_type: Type[BarData],
        ...
        from Flux.CodeGenProjects.dashboards.generated.FastApi.dashboards_service_http_routes import \
            underlying_read_bar_data_http
        from Flux.CodeGenProjects.dashboards.app.aggregate import (
    ...
    async def get_vwap_change_projection_from_bar_data_query_pre(self, bar_data_class_type: Type[BarData], symbol: str,
        ...
        from Flux.CodeGenProjects.dashboards.generated.FastApi.dashboards_service_http_routes import \
            underlying_read_bar_data_http
        from Flux.CodeGenProjects.dashboards.app.aggregate import get_vwap_change_projection_from_bar_data_agg_pipeline
        bar_data_projection_list = await underlying_read_bar_data_http(
    ...
    async def get_premium_projection_from_bar_data_query_pre(self, bar_data_class_type: Type[BarData], symbol: str,
        ...
        from Flux.CodeGenProjects.dashboards.generated.FastApi.dashboards_service_http_routes import \
            underlying_read_bar_data_http
        from Flux.CodeGenProjects.dashboards.app.aggregate import get_premium_projection_from_bar_data_agg_pipeline
        bar_data_projection_list = await underlying_read_bar_data_http(
