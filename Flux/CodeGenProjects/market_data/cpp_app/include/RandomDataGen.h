...
class RandomDataGen{
public:
    RandomDataGen():mt(std::random_device{}()), double_distribution(1, 100.0), int32_distribution(1, 100),
                    int64_distribution(1, 100),
    ...
    bool get_random_bool() {
        return int32_distribution(mt) == 1;
    }
