...
from Flux.CodeGenProjects.market_data.generated.market_data_service_model_imports import TickByTickBidAskBaseModel, \
...
class StoreTickByTickData(IbApiClient):
    ...
    def nextValidId(self, req_id: TickerId):
        self.reqMarketDataType(StoreTickByTickData.live_market_data)
    ...
    def tickByTickBidAsk(self, ticker_id: int, time: int, bid_price: float, ask_price: float,
        ...
        self.market_data_service_web_client.create_tick_by_tick_bid_ask_client(tick_by_tick_bid_ask)
