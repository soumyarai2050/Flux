...
from Flux.CodeGenProjects.market_data.generated.market_data_service_model_imports import BarDataBaseModel
...
class StoreHistoricalDataClient(IbApiClient):
    ...
    def _get_last_db_obj_date_time(self) -> datetime | None:
        try:
            db_max_id_obj = self.market_data_service_web_client.get_bar_data_query_client()
    ...
    def historicalData(self, ticker_id: int, bar: BarData):
        ...
        if do_add_to_db:
            ...
            self.market_data_service_web_client.create_bar_data_client(bar_data_base_model)
