from Flux.CodeGenProjects.market_data.app.yahoo_finance_base import *
        ...
        for symbol in self.symbols:
            ...
            if is_valid_ticker(complete_symbol):
                ...
                if symbol in self.symbol_to_symbol_overview_dict:
                    ...
                    updated_symbol_overview = market_data_service_web_client.put_symbol_overview_client(symbol_overview)
                else:
                    created_symbol_overview = market_data_service_web_client.create_symbol_overview_client(
                        symbol_overview)
