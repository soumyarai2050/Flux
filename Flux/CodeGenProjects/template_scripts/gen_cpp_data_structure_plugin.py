...
if __name__ == "__main__":
    ...
    env_var_dict["PLUGIN_FILE_NAME"] = "cpp_data_structure_plugin.py"
    # Add any custom env variable required in plugin like above

    code_gen_engine_env_manager.init_env_and_update_sys_path("template_project_name", "_", "PluginCppDataStructures", env_var_dict)
