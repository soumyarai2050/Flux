...
if __name__ == "__main__":
    ...
    env_var_dict["PLUGIN_FILE_NAME"] = "cpp_get_str_from_enum_plugin.py"
    env_var_dict["TEMPLATE_FILE_NAME"] = "template.txt"
    # Add any custom env variable required in plugin like above

    code_gen_engine_env_manager.init_env_and_update_sys_path("template_project_name", "_", "PluginCppUtilGen", env_var_dict)
