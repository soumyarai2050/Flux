...
if __name__ == "__main__":
    ...
    env_var_dict["PLUGIN_FILE_NAME"] = "filter_proto_plugin.py"

    code_gen_engine_env_manager.init_env_and_update_sys_path("template_project_name", "_", "PluginFilterProto", env_var_dict)
