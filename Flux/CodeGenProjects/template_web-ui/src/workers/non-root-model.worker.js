...
import { addxpath, getTableRows, sortColumns, getSortOrdersWithAbs, getUniqueValues } from '../utils';
...
onmessage = (e) => {
    ...
    const columns = getTableColumns(fieldsMetadata, mode, enableOverride, disableOverride, showLess, absoluteSortOverride, frozenColumns, columnNameOverride, highlightUpdateOverride);  // not used externally
