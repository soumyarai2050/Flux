...
const NumericFieldWrapper = ({ value, onChange, disabled, placeholder, decimalScale, ...props }) => {
  ...
  return (
    <NumericFormat
      ...
      value={inputValue}
      onValueChange={(values, sourceInfo) => handleChange(values.value, sourceInfo.event)}
      disabled={disabled}
      thousandSeparator="," 
