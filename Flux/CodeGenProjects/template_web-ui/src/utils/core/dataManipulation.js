...
function generatePaths(data, currentPath = '') {
    ...
    if (Array.isArray(data)) {
        ...
        data.forEach((item, index) => {
            // Append array index to the current path for each element.
    ...
    if (data && typeof data === 'object') {
        let paths = [{}]; // Initialize with an empty object to start building paths.
                    ...
                    subPaths.forEach((sp) => {
                        paths.forEach((p) => {
                            newPaths.push({
                                ...
                                [`path_${key}`]: newPath,
                                ['data-id']: newPath // Assign data-id for array elements.
                            });
                        });
                    });
                });
