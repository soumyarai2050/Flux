...
class ModelToFormattedModelGen: public FluxCodeGenerator
{
	protected:
...
template <class DescriptorType>
std::string ModelToFormattedModelGen::ClassName(const DescriptorType & descriptor) const 
{
   std::string name (descriptor.full_name());
   return name;
}

void ModelToFormattedModelGen::PrintMessage(io::Printer &printer,const FileDescriptor & file, const Descriptor & message) const 
{
...
void ModelToFormattedModelGen::PrintEnumType(io::Printer &printer,const EnumDescriptor & enummessage) const
{
...
std::string ModelToFormattedModelGen::GetFieldDefaultValueOptionString(const FieldDescriptor & field)const
{
...
std::string ModelToFormattedModelGen::GetFieldOptionsAsString(io::Printer &printer, const FieldDescriptor & field) const
{
...
void ModelToFormattedModelGen::PrintMessageOptions(io::Printer &printer, const Descriptor & message) const
{
...
void ModelToFormattedModelGen::PrintFileOptions(io::Printer &printer, const FileDescriptor & file) const
{
...
void ModelToFormattedModelGen::PopulateMessageDependencies(io::Printer &printer,const FileDescriptor & file, const Descriptor & message, 
													   std::set <std::string>& dependencyNameSet,const std::string& strCurrentFile) const
{
	for (int i = 0; i < message.field_count(); ++i)
	{
...
void ModelToFormattedModelGen::PopulateFileDependencies(io::Printer &printer, const FileDescriptor & file,
													 std::set <std::string>& dependencyNameSet) const
{
...
void ModelToFormattedModelGen::PrintDependencies(io::Printer &printer, const FileDescriptor & file) const
{
...
void ModelToFormattedModelGen::PrintMessages(io::Printer &printer, const FileDescriptor & file) const
{
...
bool ModelToFormattedModelGen::Generate(const FileDescriptor* file,
...
int main(int argc, char* argv[]) {
		...
		sleep(30);
	ModelToFormattedModelGen generator;
