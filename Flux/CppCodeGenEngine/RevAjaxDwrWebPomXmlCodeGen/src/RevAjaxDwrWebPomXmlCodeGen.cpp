...
class RevAjaxDwrWebPomXmlCodeGen: public FluxCodeGenerator {
	protected:
		void PrintMessages  (io::Printer &printer, const FileDescriptor & file) const;
		
	public:

		RevAjaxDwrWebPomXmlCodeGen(){}
...
void RevAjaxDwrWebPomXmlCodeGen::PrintMessages(io::Printer &printer, const FileDescriptor & file) const
{
	...
	printer.Print("	<groupId>project_web</groupId>\n");
	printer.Print(" <artifactId>project_web</artifactId>\n");
	printer.Print("	<version>0.0.1-SNAPSHOT</version>\n");
	printer.Print("	<packaging>war</packaging>\n");
	printer.Print("	<name>project_web</name>\n");
	...
	printer.Print("<dependency>\n");
	printer.Indent();
	printer.Print(variables, "<groupId>`project_name`-daoservice</groupId>\n");
	printer.Print(variables, "<artifactId>`project_name`-daoservice</artifactId>\n");
	printer.Print("<version>0.0.1-SNAPSHOT</version>\n");
	printer.Print("<scope>compile</scope>\n");
	printer.Outdent();
	printer.Print("</dependency>\n");
	printer.Print("<dependency>\n");
	printer.Indent();
	printer.Print("<groupId>org.directwebremoting</groupId>\n");
	printer.Print("<artifactId>dwr</artifactId>\n");
	printer.Print("<version>2.0.3</version>\n");
	printer.Outdent();
	printer.Print("</dependency>\n");
	...
	printer.Print("<dependency>\n");
	printer.Indent();
	printer.Print("<groupId>commons-dbcp</groupId>\n");
	printer.Print("<artifactId>commons-dbcp</artifactId>\n");
	printer.Print("<version>1.2.1</version>\n");
	printer.Outdent();
	printer.Print("</dependency>\n");
	printer.Print("<dependency>\n");
	printer.Indent();
	printer.Print("<groupId>commons-pool</groupId>\n");
	printer.Print("<artifactId>commons-pool</artifactId>\n");
	printer.Print("<version>1.5.3</version>\n");
	printer.Outdent();
	printer.Print("</dependency>\n");
	printer.Print("<dependency>\n");
	printer.Indent();
	...
	printer.Print("<dependency>\n");
	printer.Indent();
	printer.Print("<groupId>mysql</groupId>\n");
	printer.Print("<artifactId>mysql-connector-java</artifactId>\n");
		   printer.Print("<version>5.0.8</version>\n");
	printer.Outdent();
	printer.Print("</dependency>\n");
	printer.Print("<dependency>\n");
	printer.Indent();
	...
	printer.Print("<plugin>\n");
	printer.Indent();
	printer.Print("<groupId>org.codehaus.mojo</groupId>\n");
	printer.Print("<artifactId>tomcat-maven-plugin</artifactId>\n");
	printer.Print("<configuration>\n");
	printer.Indent();
	printer.Print("<warFile>path/to/my/warFile.war</warFile>\n");
	printer.Outdent();
	printer.Print("</configuration>\n");
	printer.Outdent();
	printer.Print("</plugin>\n");
...
bool RevAjaxDwrWebPomXmlCodeGen::Generate(const FileDescriptor* file,
...
int main(int argc, char* argv[]) {
		...
		sleep(30);
	RevAjaxDwrWebPomXmlCodeGen generator;
