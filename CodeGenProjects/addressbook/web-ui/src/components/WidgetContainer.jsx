...
const WidgetContainer = (props) => {
    ...
    return (
        <Fragment>
            ...
            {props.commonkeys && Object.keys(props.commonkeys).length > 0 && props.mode !== Modes.EDIT_MODE && <CommonKeyWidget commonkeys={props.commonkeys} />}
            <Box className={`${classes.widgetBody} ${props.mode === Modes.EDIT_MODE ? classes.widgetBodyEdit : ''}`}>
                {props.children}
            </Box>
        </Fragment>
    )
